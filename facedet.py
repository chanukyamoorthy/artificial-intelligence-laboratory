# -*- coding: utf-8 -*-
"""
Created on Wed Oct 23 09:55:08 2019
...
def reading_faces_and_displaying():
    face_array = []
    displaying_faces = []
    for face_images in glob.glob('C:/Users/student/Downloads/PCA-and-Eigen-Faces-master/Eigenfaces/Train/*.jpg'): # assuming jpg
        face_image=Image.open(face_images)
        displaying_faces.append(face_image)
        face_image = np.asarray(face_image,dtype=float)/255.0 # Normalization to 0-1
...
mean,flatten_Array=performing_pca(face_array) 
substract_mean_from_original = np.subtract(flatten_Array, mean) #covariance mat
...
def reading_test_images():
    test_images=[]
    for images in glob.glob('C:/Users/student/Downloads/PCA-and-Eigen-Faces-master/Eigenfaces/Test/*.jpg'):  # assuming jpg
...
train_list=[]
for images in glob.glob('C:/Users/student/Downloads/PCA-and-Eigen-Faces-master/Eigenfaces/Train/*.jpg'):
    a1=images
    _,a1 = a1.split('\\')
    #a1,_=a1.split('')
...
print(train_list)
test_list=[]
for images in glob.glob('C:/Users/student/Downloads/PCA-and-Eigen-Faces-master/Eigenfaces/Test/*.jpg'):
    a1=images
    _,a1 = a1.split('\\')
    a1,_=a1.split('_', maxsplit=1)
    test_list.append(a1)
